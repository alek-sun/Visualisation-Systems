...
MyMaterialDiffuse::MyMaterialDiffuse()
{
	m_vsFileName = "MyShaderDiffuse";
	m_psFileName = "MyShaderDiffuse";
}
...
void MyMaterialDiffuse::Deinit()
{
	Material::Deinit();
}

void MyMaterialDiffuse::SetMaterial(const Object * pObject)
{
